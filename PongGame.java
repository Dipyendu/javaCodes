...
class GamePanel extends JPanel implements Runnable {
    ...
    GamePanel() {
        newPaddles();
        newBall();
        newPowerUp(); // Initialize the power-up
    ...
    public void newPowerUp() {
        random = new Random();
        powerUp = new PowerUp(random.nextInt(GAME_WIDTH - BALL_DIAMETER),
    ...
    public void draw(Graphics g) {
        ...
        ball.draw(g);
        score.draw(g);
        powerUp.draw(g); // Draw the power-up
    ...
    public void checkCollision() {
        ...
        // Check collision with the power-up
        if (ball.intersects(powerUp)) {
            ball.xVelocity *= 2; // Double the ball's x velocity for a speed boost
            ball.yVelocity *= 2; // Double the ball's y velocity for a speed boost
            newPowerUp(); // Respawn the power-up in a new location
        }
